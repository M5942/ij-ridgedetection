...
public class Options {
	  ...
	  public Options(double sigma, double low, double high, int mode, double minLength, double maxLength, double slopeThreshold,boolean correct, boolean width, boolean extend, boolean postscript, boolean encapsulated, boolean image, OverlapOption overlap) {
