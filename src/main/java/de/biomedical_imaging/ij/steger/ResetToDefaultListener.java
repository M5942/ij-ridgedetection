...
public class ResetToDefaultListener implements ActionListener {
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		TextField textSlopeThresh = (TextField) gd.getNumericFields().get(3);
		textSlopeThresh.setText("" + IJ.d2s(Lines_.slopeThresholdDefault, 2));
		textSlopeThresh.setEditable(true);
		
		TextField textSigma = (TextField) gd.getNumericFields().get(4);
		textSigma.setText("" + IJ.d2s(Lines_.sigmaDefault, 2));
		textSigma.setEditable(true);
		
		TextField textLowThresh = (TextField) gd.getNumericFields().get(5);
		textLowThresh.setText("" + IJ.d2s(Lines_.lowerThreshDefault, 2));
		textLowThresh.setEditable(true);
		
		TextField textUppThresh = (TextField) gd.getNumericFields().get(6);
		textUppThresh.setText("" + IJ.d2s(Lines_.upperThreshDefault, 2));
		textUppThresh.setEditable(true);

		TextField textMinLength = (TextField) gd.getNumericFields().get(7);
		textMinLength.setText("" + IJ.d2s(Lines_.minLengthDefault, 2));
		textMinLength.setEditable(true);
		
		TextField textMaxLength = (TextField) gd.getNumericFields().get(8);
