...
public class Lines_ implements ExtendedPlugInFilter, DialogListener {
	...
	public int showDialog(ImagePlus imp, String command, PlugInFilterRunner pfr) {
		...
		gd.addNumericField("Slope_Threshold", slopeThreshold, 1);
		...
		slopeThreshold = gd.getNextNumber();
	...
	private void readSettings(){
		...
		slopeThreshold = Prefs.get("RidgeDetection.slopeThreshold", slopeThresholdDefault);
	...
	private void saveSettings(){
		...
		Prefs.set("RidgeDetection.slopeThreshold", slopeThreshold);
	...
	public void run(ImageProcessor ip) {
		...
		result.add(detect.detectLines(ip, sigma, upperThresh, lowerThresh, minLength,maxLength, isDarkLine, doCorrectPosition, doEstimateWidth, doExtendLine, overlapOption, slopeThreshold));
